...
<body style="text-align: center; background-image: url(../../Images/SysSkin/right.jpg);">
    ...
    <div style="text-align: center">
        <br />
        &nbsp;</div>
                   <table style="height: 403px; vertical-align: middle; text-align: center; border-right: #afafaf 0px dashed; border-top: #afafaf 0px dashed; border-left: #afafaf 0px dashed; border-bottom: #afafaf 0px dashed; width: 510px; background-image: url(../../Images/Skin/reg0.jpg);" cellpadding="0" cellspacing="0">
                <tr>
