...
<body style="margin-top: 0px; padding-top: 0px">
    ...
    <div>
        <table align="center" style="width: 755px; text-align: center" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="3" style="height: 130px; width: 752px;">
                    &nbsp;<asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Skin/head.jpg" /></td>
            </tr>
            <tr>
                <td style="height: 477px; width: 752px; background-image: url(../../Images/Skin/reg.jpg); vertical-align: middle; text-align: center;" 
                    colspan="3">
            ...
            <tr>
                <td colspan="3" style="height: 22px; width: 752px;">
