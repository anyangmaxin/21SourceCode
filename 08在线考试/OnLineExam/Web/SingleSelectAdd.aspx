<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SingleSelectAdd.aspx.cs" Inherits="Web_SingleSelectAdd" StylesheetTheme="MRSOFTASPNET" %>
        ...
        <tr style="background: url(../Images/lineS.jpg) repeat-x;">
          ...
          <tr>
            ...
            <td  valign="top" align="left" width="960px">
               ...
               <tr>
                    <td bgcolor="#f6dda4"  colspan="2"> <div class="title" align="left"><h4>单选题</h4></div></td>                    
                </tr>
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td >&nbsp;<div align="left"><asp:dropdownlist id="ddlAnswer" runat="server" Font-Size="9pt" Width="43px">
