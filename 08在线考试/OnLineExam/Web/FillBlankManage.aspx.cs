...
public partial class Web_FillBlankManage : System.Web.UI.Page
{
    ...
    {
        FillBlankProblemmr fillblankproblem = new FillBlankProblemmr();  //创建填空题对象
    ...
    {
        FillBlankProblemmr fill = new FillBlankProblemmr();//创建FillBlankProblemmr对象
    ...
    protected void btnFillBlank_Click(object sender, EventArgs e)
    {
        Response.Redirect("FillBlankAdd.aspx");
    }
}
