...
public partial class Web_MultiSelectManage : System.Web.UI.Page
{
    ...
    {
        MultiProblemmr multiproblem = new MultiProblemmr();  //创建多选题对象
    ...
    {
        MultiProblemmr multiproblem = new MultiProblemmr();  //创建单选题对象
    ...
    {
        MultiProblemmr multi = new MultiProblemmr();//创建MultiProblemmr对象              
    ...
    {
        Response.Redirect("MultiSelectAdd.aspx");
    }
}
