<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionManage.aspx.cs" Inherits="Web_QuestionManage" StylesheetTheme="MRSOFTASPNET" %>
          ...
          <tr>
            ...
            <td  valign="top" align="left"  width="960px">
                    ...
                    <Columns>                       
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="QuestionAdd.aspx?ID={0}" HeaderText="查看..." Text="查看..." />                                           
                        
                        <asp:CommandField ShowDeleteButton="True" HeaderText="删除" />
                    </Columns>
                </asp:GridView>
                     
                                      <asp:Button ID="Button1" runat="server" SkinID="btnSkin" 
                                          Text="&gt;&gt;问答题添加&lt;&lt;" onclick="Button1_Click" />
