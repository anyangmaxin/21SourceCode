<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SingleSelectManage.aspx.cs" Inherits="Web_SingleSelectManage" StylesheetTheme="MRSOFTASPNET" %>
  ...
  <form id="Form1" method="post" runat="server">
    ...
    <tr>
      <td style="height:4px;" colspan="3">
            <img src="../Images/top-01.jpg" style="border: 0px; left: 0px; position: relative; top: 0px;" title="" />
         </td>
    </tr>
        <tr style="background: url(../Images/lineS.jpg) repeat-x;">
          ...
          <tr>
            ...
            <td  valign="top" align="left"  width="960px">
                                      ...
                                      <h4>&gt;&gt;单选题管理</h4><hr/>
               <p align="left"><asp:DropDownList ID="ddlCourse" runat="server" AutoPostBack="True" 
                       Width="130px" OnSelectedIndexChanged="ddlCourse_SelectedIndexChanged" 
                       SkinID="ddlSkin"></asp:DropDownList></p>
                    ...
                    <Columns>                 
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="SingleSelectAdd.aspx?ID={0}" HeaderText="查看..." Text="查看..." />                                           
                        
                        <asp:CommandField ShowDeleteButton="True" HeaderText="删除" />
                    </Columns>
                </asp:GridView>
                      
                                      <asp:Button ID="btn" runat="server" onclick="btn_Click" SkinID="btnSkin" 
                                          Text="&gt;&gt;单选题添加&lt;&lt;" />
