<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JudgeManage.aspx.cs" Inherits="Web_JudgeManage" StylesheetTheme="MRSOFTASPNET" %>
          ...
          <tr>
            ...
            <td  valign="top" align="left"  width="960px">
                    ...
                    <Columns>                       
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="JudgeAdd.aspx?ID={0}" HeaderText="查看..." Text="查看..." />                                           
                        
                        <asp:CommandField ShowDeleteButton="True" HeaderText="删除" />
                    </Columns>
                </asp:GridView>
                      
                                      <asp:Button ID="btnAddJudge" runat="server" SkinID="btnSkin" 
                                          Text="&gt;&gt;判断题添加&lt;&lt;" onclick="btnAddJudge_Click" />
