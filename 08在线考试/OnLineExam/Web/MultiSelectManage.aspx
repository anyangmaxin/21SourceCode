<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultiSelectManage.aspx.cs" Inherits="Web_MultiSelectManage" StylesheetTheme="MRSOFTASPNET" %>
          ...
          <tr>
            ...
            <td  valign="top" align="left"  width="960px">
                    ...
                    <Columns>                       
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="ID" DataNavigateUrlFormatString="MultiSelectAdd.aspx?ID={0}" HeaderText="查看..." Text="查看..." />                                           
                        
                        <asp:CommandField ShowDeleteButton="True" HeaderText="删除" />
                    </Columns>
                </asp:GridView>
                                      <asp:Button ID="btnAddMulti" runat="server" onclick="btnAddMulti_Click" 
                                          SkinID="btnSkin" Text="&gt;&gt;多选题添加&lt;&lt;" />
