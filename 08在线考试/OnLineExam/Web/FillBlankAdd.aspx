<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FillBlankAdd.aspx.cs" Inherits="Web_FillBlankAdd" StylesheetTheme="MRSOFTASPNET" %>
        ...
        <tr style="background: url(../Images/lineS.jpg) repeat-x;">
          ...
          <tr>
            ...
            <td  valign="top" align="left"  width="960px">
               ...
               <tr>
                    <td bgcolor="#f6dda4" colspan="2"> <div class="title" align="left"><h4>填空题</h4></div></td>                    
                </tr>
                <tr>
                    <td bgcolor="#f6dda4" style="text-align:right;" width="80px">科目：</td>
                    <td >&nbsp;<div align="left"><asp:dropdownlist id="ddlCourse" runat="server" Font-Size="9pt" Width="88px" SkinID="ddlSkin"></asp:dropdownlist></div>
                    </td>
                </tr>
               
                <tr>
                    <td bgcolor="#f6dda4" style="text-align:right;"> 前描述：</td>
                    <td >&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtFrontTitle"
                            ErrorMessage="不能为空！"></asp:RequiredFieldValidator><div align="left"><asp:textbox id="txtFrontTitle"  runat="server" Width="100%" TextMode="MultiLine"
								Height="60px"></asp:textbox>
                       </div></td>
                </tr>
                 <tr>
                    <td bgcolor="#f6dda4" style="text-align:right;">后描述：</td>
                    <td >&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtBackTitle"
                            ErrorMessage="不能为空！"></asp:RequiredFieldValidator><div align="left"><asp:textbox id="txtBackTitle"  runat="server"  Width="100%" TextMode="MultiLine"
