...
namespace OnLineExam.BusinessClass
{
    ...
    public class SingleProblemmr
    {
        ...
        public bool LoadData(int TID)
        {
            ...
            string strsql = "SELECT * FROM SingleProblemmr where ID=@ID";
        ...
        public bool InsertByStr()
        {
            ...
            DataBase DB = new DataBase();
            string strsql = "INSERT INTO SingleProblemmr (CourseID,Title,AnswerA,AnswerB,AnswerC,AnswerD,Answer) VALUES (@CourseID,@Title,@AnswerA,@AnswerB,@AnswerC,@AnswerD,@Answer)";
        ...
        public bool UpdateByStr(int TID)
        {
            ...
            DataBase DB = new DataBase();
            string strsql = "UPDATE SingleProblemmr SET CourseID= @CourseID,Title= @Title,AnswerA= @AnswerA,AnswerB= @AnswerB,AnswerC= @AnswerC,AnswerD= @AnswerD,Answer= @Answer WHERE (ID= @ID)";
        ...
        public bool DeleteByStr(int TID)
        {
            ...
            DataBase DB = new DataBase();
            string strsql = "DELETE FROM SingleProblemmr WHERE (ID= @ID)";
            Params[0] = DB.MakeInParam("@ID", SqlDbType.Int,4, TID);               //题目编号          
        ...
        public DataSet QuerySingleProblem(int TCourseID)
        {
            ...
            DataBase DB = new DataBase();
            string strsql = "SELECT SingleProblemmr.ID, SingleProblemmr.Title FROM SingleProblemmr where CourseID=@CourseID";
