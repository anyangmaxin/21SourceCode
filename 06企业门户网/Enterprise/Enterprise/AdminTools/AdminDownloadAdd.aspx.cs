...
public partial class AdminTools_AdminDownloadAdd : System.Web.UI.Page
{
        ...
        for (int i = 0; i < HFC.Count; i++)
        {
            ...
            try
            {
                ...
                if (UserHPF.ContentLength > 0)
                {
                    ...
                    this.LblSoft.Text = System.IO.Path.GetFileName(UserHPF.FileName).ToString();
                }
            }
            catch
            {
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
       string FullFileName = this.FileUpload1.PostedFile.FileName;
        ...
        if (type == "rar" )
        {
            ...
            try
            {
                this.LblSoft.Text = "Mend/" + this.LblSoft.Text;
                String SqlInsert = "Insert tb_uptools values ('" + this.LblSoft.Text + "')";
