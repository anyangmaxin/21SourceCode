<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataTime.aspx.cs" Inherits="Default2" %>
    ...
    function display_month ( form )  {
        ...
        for ( var row=0; row<6; row++) {
            for ( var col=0; col<7; col++ )
            {
                ...
                form.dayBox[(row*7)+col].style.color = "#000000";
...
<body onLoad="Cstartup(document.form1)" topmargin="0">
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="3"><table border="0" cellpadding="1" cellspacing="0" align="center" style="background-color: #ffcccc">
            <tr>
              <td bgcolor="#82664F" style="width: 229px"><table border="0" cellpadding="0" cellspacing="0">
