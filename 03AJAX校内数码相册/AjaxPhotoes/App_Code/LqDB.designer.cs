...
[System.Data.Linq.Mapping.DatabaseAttribute(Name="db_21")]
...
public partial class tb_userInfo : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_userPass", DbType="VarChar(50)")]
	...
	[Column(Storage="_sex", DbType="Char(10)")]
	public string sex
	{
		get
		{
	...
	[Column(Storage="_emaile", DbType="VarChar(50)")]
...
public partial class Photo : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_Descript", DbType="VarChar(100)")]
	...
	[Column(Storage="_P_Type", DbType="VarChar(20)")]
	...
	[Column(Storage="_P_Size", DbType="Int")]
	...
	[Association(Name="Photo_Category_Photo", Storage="_Photo_Category", ThisKey="CategoryID", IsForeignKey=true)]
...
public partial class Photo_Category : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Column(Storage="_C_Name", DbType="VarChar(50)")]
	...
	[Column(Storage="_C_Status", DbType="VarChar(50)")]
	...
	[Association(Name="Photo_Category_Photo", Storage="_Photo", OtherKey="CategoryID")]
